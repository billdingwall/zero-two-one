...
3. **Spec Kit status** — if in MVP Build or later (Phase 1+), run `npm run 021-spec:status -- list` to show all feature specs and their gate states
