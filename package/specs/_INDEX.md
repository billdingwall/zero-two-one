...
| [002-migrate-mode](002-migrate-mode/spec.md) | Migrate-Mode — detection, phase/stack interview, existing-doc import + duplicate resolution, Spec Kit reuse (TDD §8/§6) | mvp-3 | In Progress |
