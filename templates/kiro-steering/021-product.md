...
- Check the current phase with `npx 021 status`, or read `.zero-two-one.json` (the manifest records the lifecycle phase and tool stack) instead of inferring from directory contents.
