...
1. **Key Docs (`01-PRD.md`, `EDD.md`, `02-TDD.md`)**
...
4. **Spec-Driven Delivery (SSD)**
   Items are pulled from the backlog into the SSD pipeline (SpecKit branches). The `.ai/context/` generation script automatically bundles `CODE.md`, `PRODUCT.md`, and `04-BACKLOG.md` to ensure the AI agent understands the implementation requirements within the context of the living architecture.
