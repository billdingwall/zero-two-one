...
1. **Context Generation:** Run `npm run spec:context` to generate the `.ai/context/NNN-feature-name.md` bundle. This seamlessly injects `CODE.md`, `PRODUCT.md`, and `04-BACKLOG.md`.
