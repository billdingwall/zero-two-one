...
One file per roadmap release (r4; TDD §2). MVP releases (`mvp-N.md`) are the delivery units of the MVP roadmap, sequenced in engineering-dependency order (r5); Growth releases (`v<major.minor>-<theme>.md`) each tie to a release branch and promote backlog items into SSD specs. [04-ROADMAP.md](../04-ROADMAP.md) keeps the summary and links here for detail.
