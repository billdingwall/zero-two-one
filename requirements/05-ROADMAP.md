...
| [mvp-4](_releases/mvp-4.md) | AI-Led Init & Stack/Design Adapters — three-layer model (neutral core + per-stack adapters at init); spec cut 006 source-layer/stack-parameterized renderer · 007 Antigravity · 008 Kiro + engine dispatch · 009 `021` CLI; `material-3`; 3×{none,material-3} matrix **+ neutral-core invariant**; API-surface decision (r9) | ◻ Planned | High | mvp-3 | MVP Build |
