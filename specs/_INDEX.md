...
| [004-workflow-doctor](004-workflow-doctor/spec.md) | Workflow-Manager — read-only `021-doctor` drift reporter reconciling manifest/spec/release/roadmap state (TDD §13, r7) | mvp-3 | Draft |
