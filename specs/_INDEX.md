...
| [003-manifest-qa-contract](003-manifest-qa-contract/spec.md) | Manifest as QA Contract — one `lib.js` parser for phase/stack; retire run-qa output-scraping (TDD §7, r7) | mvp-3 | Draft |
