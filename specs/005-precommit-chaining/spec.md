...
- **FR-005 — lefthook integration.** With lefthook detected, init **reports the exact `pre-commit` command snippet** for the user to add and sets strategy `manual` *(clarified 2026-07-16)*; it **never edits** the lefthook config (safe under zero-dep + `yml/yaml/toml/json` variety).
